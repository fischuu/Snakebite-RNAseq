...
if(!is.element("snakemake",ls())){
  projFolder <- "/hdd/data2/Projects/MastitisChallenge/"
  pipelineFolder <- "~/git/Pipeline-RNA-seq/"
  pipelineConfig <- "~/git/Project-MastitisChallenge/Analyses/RNASeq-Analysis/Pipeline-RNA-seq_config.yaml"
}
```
